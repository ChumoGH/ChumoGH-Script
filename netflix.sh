...
make install
badvpn-udpgw --listen-addr 127.0.0.1:7200 --max-connections-for-client 1000 --max-connections-for-client 50 > /dev/nul &
echo 'badvpn-udpgw --listen-addr 127.0.0.1:7200 --max-connections-for-client 1000 --max-connections-for-client 50 > /dev/nul &' > /etc/rc.local
